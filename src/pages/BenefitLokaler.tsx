      ...
      <main className="pb-20 md:pb-0">
        ...
        <div className="bg-neutral-50 border-b border-border">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
            <nav className="flex items-center gap-2 text-sm">
              ...
              <span className="text-muted-foreground">/</span>
              <span className="text-muted-foreground">Lokaler Support – Köln & Umgebung</span>
            </nav>
          </div>
        </div>
        ...
        <section className="py-16 bg-gradient-to-b from-white to-neutral-50">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <h1 className="text-hero mb-4">Lokaler Support – Köln & Umgebung</h1>
            <p className="text-subtitle">Schnell vor Ort, persönlich erreichbar, pragmatisch gelöst.</p>
          </div>
        </section>
              ...
              <div className="lg:col-span-2 space-y-12">
                ...
                <div>
                  ...
                  <div className="bg-neutral-50 border border-border rounded-xl p-6">
                    <p className="text-foreground leading-relaxed">
                      „Drucker streikt vor einem Kundentermin (Sülz). Diagnose remote in 30 Min., Ersatztoner mitgebracht, Vor-Ort-Fix in 20 Min. Meeting fand pünktlich statt."
                    </p>
                  </div>
                </div>
              </div>
