      ...
      <main className="pb-20 md:pb-0">
        ...
        <div className="bg-neutral-50 border-b border-border">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
            <nav className="flex items-center gap-2 text-sm">
              ...
              <span className="text-muted-foreground">/</span>
              <span className="text-muted-foreground">Schneller Support – remote oder vor Ort</span>
            </nav>
          </div>
        </div>
        ...
        <section className="py-16 bg-gradient-to-b from-white to-neutral-50">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <h1 className="text-hero mb-4">Schneller Support – remote oder vor Ort</h1>
            <p className="text-subtitle">Kurze Wege, klare Antworten.</p>
          </div>
        </section>
              ...
              <div className="lg:col-span-2 space-y-12">
                ...
                <div>
                  <p className="text-foreground leading-relaxed">
                    Schneller Support bedeutet bei uns: Hotline ohne Warteschleife, WhatsApp für schnelle Anfragen und sicherer Remotezugriff, wenn möglich. Vor-Ort-Service gibt es in Köln und Umgebung, wenn remote nicht ausreicht. Ein Ansprechpartner für alles – keine Weiterleitung zwischen verschiedenen Ebenen. Wir arbeiten effizient: Erst Ferndiagnose, dann gezielter Vor-Ort-Einsatz, falls nötig. Das spart Zeit und Kosten. Anders als beim klassischen Break-Fix mit Ticket-Ping-Pong und stundenlanges Warten auf Rückruf haben Sie bei uns verbindliche Reaktionszeiten und einen direkten Draht. Unser Ziel ist es, Probleme schnell und nachhaltig zu lösen, nicht nur Symptome zu behandeln.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <div className="bg-neutral-50 border border-border rounded-xl p-6">
                    <p className="text-foreground leading-relaxed">
                      „E-Mail funktioniert nicht mehr (Chorweiler). WhatsApp-Anfrage um 14:00, Remote-Fix um 15:30. Postfach wieder erreichbar, Ursache erklärt."
                    </p>
                  </div>
                </div>
              </div>
...
export default BenefitSchnellerSupport;